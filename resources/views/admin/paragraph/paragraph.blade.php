...
@endif
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            font-size: 50px;">Create Multiple Paragraphss</h1>
            <div class="panel-body">
                <form action="{{ url('paragraph') }}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <!-- Add Paragraph button -->
                    <div class="button-row">
                        <!-- Add Paragraph button -->
                        <button type="button" id="add_paragraph" class="btn btn-info add-paragraph-button">Add Paragraph</button>
                    </div>
...
function addParagraph() {
    ...
    <div class="form-group col-5">
        ...
        <div class="input-group">
            <input type="number" name="paragraphs[${paragraphCounter}][time]" class="form-control file-upload-info" placeholder=""">
         <span class=" input-group-append"></span>
        </div>
    </div>
