...
<!--sha512-siarrzI1u3pCqFG2LEzi87McrBmq6Tp7juVsdmGY1Dr8Saw+ZBAzDzrGwX3vgxX1NkioYNCFOVC0GpDPss10zQ==-->
...
<body>
  <div class="container-scroller">
    @include('experts.partials.navbar')
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        @include('experts.partials.settings-panel')
      ...
      @include('experts.partials.sidebar')

      <!-- partial -->
      <div class="main-panel">
        <div class="content-wrapper">
            @yield('experts-content')
<!-- 
          {{-- <div class="row">
        ...
        <footer class="footer">
            @include('experts.partials.footer')
<!-- {{--
          /<div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2021.  Premium <a href="https://www.bootstrapdash.com/" target="_blank">Bootstrap experts template</a> from BootstrapDash. All rights reserved.</span>
